...
namespace Makka\NepaliDate;

class NepaliDate
{
    // Data for nepali date
    public static  $_bs = array(
    ...
    public static $_nep_date = array('year' => '', 'month' => '', 'date' => '', 'day' => '', 'nmonth' => '', 'num_day' => '');

    public static $_eng_date = array('year' => '', 'month' => '', 'date' => '', 'day' => '', 'emonth' => '', 'num_day' => '');
     ...
     * @return string
     */
    public static function _get_day_of_week($day)
    {
        switch ($day)
        {
            case 1:
     ...
     * @return string
     */
    public static function _get_english_month($m)
    {
        $eMonth = FALSE;
        switch ($m)
        {
     ...
     * @return bool
     */
    public static function _is_in_range_eng($yy, $mm, $dd)
    {
        if ($yy < 1944 || $yy > 2033)
        {
     ...
     * @return bool
     */
    public static function _is_in_range_nep($yy, $mm, $dd)
    {
        if ($yy < 2000 || $yy > 2089)
        {
